        ...
        <Tabs>
          ...
          <TabPanel>
            {editImage ? (
              <EditImageForm
                image={editImage}
                updatedInformation={updatedInformationImages}
                closeForm={closeForm}
              ></EditImageForm>
            ) : null}
            <EditableImageList
              images={images}
              editBtn={editImageBtn}
          ...
          <TabPanel>
            {editVideo ? (
              <EditVideoForm
                video={editVideo}
                updatedInformation={updatedInformationVideos}
                closeForm={closeForm}
              ></EditVideoForm>
            ) : null}
            <EditableVideoList
              videos={videos}
              editBtn={editVideoBtn}
          ...
          <TabPanel>
            {editVirtualTour ? (
              <EditVirtualTourForm
                virtualtour={editVirtualTour}
                updatedInformation={updatedInformationVirtualTours}
                closeForm={closeForm}
              ></EditVirtualTourForm>
            ) : null}
            <EditableVirtualTourList
              virtualtours={virtualtours}
              editBtn={editVirtualTourBtn}
              deleteBtn={deleteVirtualTourBtn}
            ></EditableVirtualTourList>
          </TabPanel>
        </Tabs>
